...
float AverageOfNumbersInArray(int Size, float Sum)
{
    return Sum / Size;
}
...
int main()
{
    ...
    float Sum = SumOfNumbersInArray(arr, Size);

    cout << "\nAverage of numbers in the array = " << AverageOfNumbersInArray(Size, Sum) << endl;
